...
<html>
	<head>
		<title>Job Finder-Land Your Dream Job</title>
		<meta charset="utf-8">
...
<!-- NAVBAR -->
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p style="color:#24141e">Get Instant Access To Today's Most Wonderful Hiring Tools-Post Jobs and Streamline Your Entire Hiring Process</p>
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <h2 class="featurette-heading">Looking for Job?</h2>
        </div>
        <div class="col-md-5" >
    ...
    <div class="container marketing">
      ...
      <footer>
        ...
        <p>&copy; 2021 Job Finder &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
      </footer>
